...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(611, 746)
        MainWindow.setMinimumSize(QSize(0, 0))
        MainWindow.setMaximumSize(QSize(4324234, 2342343))
...
"")
        ...
        self.all_windows.setGeometry(QRect(30, 10, 661, 641))
        self.all_windows.setMinimumSize(QSize(0, 0))
        self.all_windows.setMaximumSize(QSize(23423, 16777215))
...
"border-radius: 10px")
        ...
        self.show_users.setGeometry(QRect(20, 10, 541, 591))
...
"background-color: qlineargradient(spread:repeat, x1:0, y1:0, x2:1, y2:1, stop:0 rgba(243, 159, 255, 255), stop:1 rgba(255, 255, 255, 255));")
        ...
        self.user_for_you.setGeometry(QRect(70, 20, 411, 451))
...
"border-radius:  30px")
        ...
        self.photo.setGeometry(QRect(110, 10, 191, 201))
        self.photo.setStyleSheet(u"border: 0px")
        self.photo.setScaledContents(True)
        self.name = QLabel(self.user_for_you)
        self.name.setObjectName(u"name")
        self.name.setGeometry(QRect(10, 240, 101, 21))
        font = QFont()
        ...
        self.horizontalWidget_2.setGeometry(QRect(10, 270, 391, 41))
...
"border: 0px")
        ...
        self.gridWidget.setGeometry(QRect(10, 320, 391, 111))
        ...
        self.like_button.setGeometry(QRect(130, 510, 61, 51))
...
"")
        ...
        self.dis_button.setGeometry(QRect(370, 510, 61, 51))
...
"")
        ...
        self.user_profile.setGeometry(QRect(10, 20, 551, 571))
...
"background-color: transparent")
        ...
        self.verticalLayoutWidget.setGeometry(QRect(10, 20, 241, 231))
        ...
        self.chats.setGeometry(QRect(-60, 30, 611, 571))
        ...
        self.navigation.setGeometry(QRect(30, 630, 571, 51))
...
"border: 1px solid rgb(143, 143, 143);")
        ...
        self.horizontalLayoutWidget.setGeometry(QRect(0, 0, 571, 51))
...
"border: 1px solid rgb(255, 255, 255)")
        ...
        self.all_windows.setCurrentIndex(1)
